...
urlpatterns= (
    ...
    url(r'^usuario_opciones/', login_required(usuario_opciones), name='usuario_opciones'),
    url(r'^lista/', login_required(UsuarioLista.as_view()), name='usuario_lista'),
    url(r'^results/$', login_required(search), name='search'),
    url(r'^registrar/', RegistrarUsuario.as_view(), name="usuario_registrar"),
    url(r'^editar/(?P<pk>\d+)/$', login_required(ActualizarUsuario.as_view()), name='usuario_editar'),
    url(r'^eliminar/(?P<pk>\d+)/$',login_required(EliminarUsuario.as_view()), name='usuario_eliminar'),
)
